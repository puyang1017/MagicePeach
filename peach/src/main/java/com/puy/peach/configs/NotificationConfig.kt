...
data class NotificationConfig(
     ...
     * 渠道id
     */
    var channelId: String = "Peach",
    /**
     * 渠道名
     */
    var channelName: String = "Peach",
    /**
     * 标题名
     */
    var title: String = "Peach",
    /**
     * 通知栏内容
     */
    var content: String = "Peach is running",
    /**
     * 小图标
     */
    var smallIcon: Int = R.drawable.icon_peach_small,
    /**
     * 大图标
     */
    var largeIcon: Int = 0,
    ...
    constructor(source: Parcel) : this(
        source.readInt(),
        source.readString() ?: "Peach",
        source.readString() ?: "Peach",
        source.readString() ?: "Peach",
        source.readString() ?: "The app of peach is running",
        source.readInt(),
        source.readInt(),
